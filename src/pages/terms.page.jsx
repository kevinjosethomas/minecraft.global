      ...
      <div className="flex flex-col items-start justify-start w-full py-24 px-10 lg:px-20 2xl:px-56 space-y-10 bg-dark-80">
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="font-medium text-gray-500">
            ...
            materials on minecraft.global's Website for personal, non-commercial
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="font-medium text-gray-500">
            All the materials on minecraft.global’s Website are provided "as
            is". minecraft.global makes no warranties, may it be expressed or
            implied, therefore negates all other warranties. Furthermore,
            minecraft.global does not make any representations concerning the
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="font-medium text-gray-500">
            Any claim related to minecraft.global's Website shall be governed by
            the laws of ca without regards to its conflict of law provisions.
          </p>
        </div>
      </div>
    </StandardLayout>
