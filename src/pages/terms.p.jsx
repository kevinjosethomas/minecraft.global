  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-start justify-start space-y-10">
        <h1 className="text-6xl font-bold text-white text-opacity-80">
          Terms of Service
        </h1>
        <div className="flex flex-col items-start justify-center">
          <h2 className="text-4xl font-bold text-white text-opacity-80">
            1. Terms
          </h2>
          <p className="tracking-wide text-white text-opacity-60">
            By accessing this Website, accessible from https://minecraft.global,
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="tracking-wide text-white text-opacity-60">
            ...
            materials on minecraft.global&apos;s Website for personal,
          ...
          <p className="tracking-wide text-white text-opacity-60">
            This will let minecraft.global to terminate upon violations of any
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="tracking-wide text-white text-opacity-60">
            All the materials on minecraft.global’s Website are provided
            &quot;as is&quot;. minecraft.global makes no warranties, may it be
            expressed or implied, therefore negates all other warranties.
            Furthermore, minecraft.global does not make any representations
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="tracking-wide text-white text-opacity-60">
            minecraft.global or its suppliers will not be hold accountable for
            any damages that will arise with the use or inability to use the
            materials on minecraft.global’s Website, even if minecraft.global or
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="tracking-wide text-white text-opacity-60">
            The materials appearing on minecraft.global’s Website may include
            technical, typographical, or photographic errors. minecraft.global
            will not promise that any of the materials in this Website are
            accurate, complete, or current. minecraft.global may change the
            materials contained on its Website at any time without notice.
            minecraft.global does not make any commitment to update the
            materials.
          </p>
        </div>
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="tracking-wide text-white text-opacity-60">
            minecraft.global has not reviewed all of the sites linked to its
            Website and is not responsible for the contents of any such linked
            site. The presence of any link does not imply endorsement by
            minecraft.global of the site. The use of any linked website is at
            the user’s own risk.
          </p>
        </div>
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="tracking-wide text-white text-opacity-60">
            minecraft.global may revise these Terms of Use for its Website at
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="format-links tracking-wide text-white text-opacity-60">
            Please read our{" "}
            <Link href="/privacy">
              <a>Privacy Policy</a>
            </Link>
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="tracking-wide text-white text-opacity-60">
            Any claim related to minecraft.global&apos;s Website shall be
