    ...
    if (error) {
      ...
      switch (error.response?.status) {
        case 401:
          ...
          break;
        case 409:
          if (error === "duplicate_vanity") toast.error("The provided vanity URl is alreay taken!");
          else if (error === "duplicate_server") toast.error("Another server already uses that host and port!");
