    ...
    <div className="flex flex-row items-center justify-between w-full space-x-8">
      <div className="flex flex-col items-start justify-start space-y-2">
        <p className="max-w-md text-lg text-white text-opacity-90">
          Server Analytics provides you with a Bukkit plugin to add to your server. The plugin sends
          data to our site every hour and we intuitively display various graphs and statistics that
          can help you make data-driven decisions for your server&apos;s growth!
        </p>
      ...
      <div className="flex flex-col items-center justify-center max-w-xs px-3 py-12 space-y-6 bg-olive-940 rounded-lg border-2 border-olive-800">
