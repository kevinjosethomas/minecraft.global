    ...
    <div className="flex flex-col items-start justify-start max-w-[300px] space-y-4">
      <Link href={`/server/${props.server.server_id}`}>
        <a className="group flex flex-row items-center justify-center w-full py-2.5 space-x-3 bg-olive-950 hover:bg-olive-940 border-2 border-olive-930 rounded-lg transition duration-300">
          ...
          <p className="text-xl text-white text-opacity-90 select-none">View Server</p>
        </a>
      </Link>
      ...
      <div
        className="flex flex-row items-center justify-center w-full py-3 bg-olive-900 hover:bg-olive-800 rounded-lg transition duration-300 cursor-pointer"
