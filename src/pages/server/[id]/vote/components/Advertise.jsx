...
export default function Advertise(props) {
  return (
    <div className="flex flex-col items-star justify-start w-full h-[416px] p-8 space-y-4 bg-olive-950 rounded border-2 border-olive-920">
      <div className="flex flex-col items-start justify-start w-full space-y-1">
        ...
        <p className="text-2xl text-white text-opacity-60">
