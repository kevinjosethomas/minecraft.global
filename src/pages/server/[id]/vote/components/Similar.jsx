...
export default function Similar(props) {
  return (
    <motion.div
      className="hidden h-[220px] w-full flex-row items-center justify-between overflow-hidden rounded border-2 border-olive-920 bg-olive-950 md:flex"
    ...
    >
      <div className="flex h-full flex-col items-start justify-between p-8">
        <div className="flex flex-col items-start justify-start">
          <div className="flex flex-row items-center justify-start space-x-2">
            ...
            <Link href={`/tag/${props.tag}`}>
              <a className="group flex cursor-pointer flex-row items-center justify-start space-x-1.5 rounded-[4px] bg-white bg-opacity-[0.06] px-2.5 py-0.5 transition duration-300 hover:bg-opacity-10">
        ...
        <Link href={`/tag/${props.tag}`}>
          <a className="group flex select-none flex-row items-center justify-center space-x-2 rounded-[6px] bg-olive-600 bg-opacity-25 px-4 py-2 transition duration-300 hover:bg-opacity-50">
