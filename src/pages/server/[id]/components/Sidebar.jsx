...
function Element(props) {
  return (
    ...
    >
      <h3 className="font-medium text-[24px] text-white text-opacity-80 leading-tight">
        {props.label}
      </h3>
      <h4 className="text-[24px] text-white text-opacity-60 leading-tight">{props.content}</h4>
    </div>
  );
}
...
function SocialElement(props) {
  return (
    ...
    >
      <i
        className={`${props.icon} w-[30px] text-[24px] text-white text-opacity-60 text-center group-hover:text-opacity-70 transition duration-300`}
      />
      <h3 className="text-[24px] text-white text-opacity-60 leading-tight group-hover:text-opacity-70 transition duration-300 select-none">
        {props.label}
      </h3>
    </a>
  );
