    ...
    <Default>
      <div className="flex flex-row items-center justify-between w-full py-5">
        ...
        <Tilt tiltMaxAngleX={2} tiltMaxAngleY={2} tiltReverse>
          <div className="flex flex-col items-start justify-start w-[450px] rounded-[12px] border-2 border-olive-940 overflow-hidden">
...
function Feature(props) {
  return (
    <div className="flex flex-row items-center justify-start space-x-2">
      <i className={`${props.icon} w-[30px] text-[24px] text-center`} />
