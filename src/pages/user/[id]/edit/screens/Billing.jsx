    ...
    <div className="flex flex-col items-start justify-start w-full p-10 space-y-4 bg-olive-950 rounded border-2 border-olive-940">
      ...
      <div className="flex flex-col items-start justify-start w-full rounded overflow-hidden">
        <div className="flex flex-row items-center justify-between w-full px-4 py-2 bg-black bg-opacity-20">
          <span className="w-[8%] font-medium text-xl text-white text-opacity-80">Index</span>
          <span className="w-[8%] font-medium text-xl text-white text-opacity-80">Price</span>
          <span className="w-[33%] font-medium text-xl text-white text-opacity-80">Label</span>
          <span className="w-[18%] font-medium text-xl text-white text-opacity-80">Server</span>
          <span className="w-[18%] font-medium text-xl text-white text-opacity-80">Date</span>
        </div>
