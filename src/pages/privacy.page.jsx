  ...
  return (
    <StandardLayout>
      <div className="flex flex-col items-start justify-start w-full py-24 px-10 lg:px-20 2xl:px-56 space-y-10 bg-dark-80">
        <span className="font-bold text-5xl md:text-6xl text-gray-300">Privacy Policy</span>
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="font-medium text-gray-500">We are a Data Controller of your information.</p>
          ...
          <l>
            ...
            <li className="font-medium text-gray-500">The right of rectification.</li>
            <li className="font-medium text-gray-500">The right to object.</li>
            <li className="font-medium text-gray-500">The right of restriction.</li>
            <li className="font-medium text-gray-500">The right to data portability</li>
            <li className="font-medium text-gray-500">The right to withdraw consent</li>
          </l>
        </div>

        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Log Files</h2>
        ...
        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Cookies and Web Beacons</h2>

          <p className="font-medium text-gray-500">
            Like any other website, minecraft.global uses 'cookies'. These cookies are used to store
        ...
        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Our Advertising Partners</h2>
        ...
        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Privacy Policies</h2>
          ...
          <p className="font-medium text-gray-500">
            ...
            minecraft.global, which are sent directly to users' browser. They automatically receive
        ...
        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Third Party Privacy Policies</h2>

          <p className="font-medium text-gray-500">
            minecraft.global's Privacy Policy does not apply to other advertisers or websites. Thus,
        ...
        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Children's Information</h2>
        ...
        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Online Privacy Policy Only</h2>
        ...
        <div className="flex flex-col items-start justify-center">
          <h2 className="font-bold text-3xl text-gray-400">Consent</h2>
