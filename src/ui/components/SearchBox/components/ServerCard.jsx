...
export default function ServerCard(props) {
  return (
    <Link href={`/server/${props.server_id}`} passHref>
      <div className="flex cursor-pointer select-none items-center justify-start space-x-4 rounded-[6px] p-3 transition duration-300 hover:bg-white hover:bg-opacity-[0.04]">
        <img
...
const ServerCardSkeleton = () => {
  return (
    <SkeletonTheme baseColor="#25312D" highlightColor="#1E2A26">
      <div className="flex select-none items-center justify-start space-x-4 p-3">
